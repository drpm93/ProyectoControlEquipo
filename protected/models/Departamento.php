...
class Departamento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nomdepar', 'required'),
			array('nomdepar', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('iddepartamento, nomdepar', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fichas' => array(self::HAS_MANY, 'Ficha', 'idarea'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nomdepar',$this->nomdepar,true);
