...
class Actividad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nomactividad', 'required'),
			array('nomactividad', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idactividad, nomactividad', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fichas' => array(self::HAS_MANY, 'Ficha', 'idactividad'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nomactividad',$this->nomactividad,true);
