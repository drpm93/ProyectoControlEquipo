...
/* @var $data Bajacelulares */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('idbajacelular')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->idbajacelular), array('view', 'id'=>$data->idbajacelular)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('idfichacelular')); ?>:</b>
	<?php echo CHtml::encode($data->idfichacelular); ?>
	<br />
